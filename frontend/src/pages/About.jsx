    ...
    return (
        <div>
            ...
            <div className="flex flex-col md:flex-row gap-12 my-10">
                <img src={assets.about_image} alt="" className="w-full md:max-w-[360px] object-cover" />
            ...
            <div className="flex flex-col md:flex-row mb-20">
                <div className="flex flex-col gap-5 px-10 py-8 md:px-16 sm:py-16 border text-[15px] flex-1 hover:bg-primary hover:text-white transition-all duration-300 text-gray-600 cursor-pointer">
                    <b>EFFICIENCY:</b>
